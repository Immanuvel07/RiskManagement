/* checksum : 7b6dbb1e0c33ef27a66ff1cb882f32a7 */
@cds.external : true
...
entity DELL.A_AddressEmailAddress {
...
entity DELL.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity DELL.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity DELL.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity DELL.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity DELL.A_BPAddressIndependentEmail {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPAddressIndependentFax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPAddressIndependentMobile {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPAddressIndependentPhone {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPAddressIndependentWebsite {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many DELL.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many DELL.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many DELL.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many DELL.A_AddressPhoneNumber {  };
  to_URLAddress : Association to many DELL.A_AddressHomePageURL {  };
};
...
entity DELL.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity DELL.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BusinessPartner {
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_AddressIndependentEmail : Association to many DELL.A_BPAddressIndependentEmail {  };
  to_AddressIndependentFax : Association to many DELL.A_BPAddressIndependentFax {  };
  to_AddressIndependentMobile : Association to many DELL.A_BPAddressIndependentMobile {  };
  to_AddressIndependentPhone : Association to many DELL.A_BPAddressIndependentPhone {  };
  to_AddressIndependentWebsite : Association to many DELL.A_BPAddressIndependentWebsite {  };
  to_BPCreditWorthiness : Association to DELL.A_BPCreditWorthiness {  };
  to_BPDataController : Association to many DELL.A_BPDataController {  };
  to_BPEmployment : Association to many DELL.A_BPEmployment {  };
  to_BPFinServicesReporting : Association to DELL.A_BPFinancialServicesReporting {  };
  to_BPFiscalYearInformation : Association to many DELL.A_BPFiscalYearInformation {  };
  to_BPRelationship : Association to many DELL.A_BPRelationship {  };
  to_BuPaIdentification : Association to many DELL.A_BuPaIdentification {  };
  to_BuPaIndustry : Association to many DELL.A_BuPaIndustry {  };
  to_BusinessPartner : Association to DELL.A_BPFinancialServicesExtn {  };
  to_BusinessPartnerAddress : Association to many DELL.A_BusinessPartnerAddress {  };
  to_BusinessPartnerAlias : Association to many DELL.A_BusinessPartnerAlias {  };
  to_BusinessPartnerBank : Association to many DELL.A_BusinessPartnerBank {  };
  to_BusinessPartnerContact : Association to many DELL.A_BusinessPartnerContact {  };
  to_BusinessPartnerIsBank : Association to DELL.A_BusinessPartnerIsBank {  };
  to_BusinessPartnerRating : Association to many DELL.A_BusinessPartnerRating {  };
  to_BusinessPartnerRole : Association to many DELL.A_BusinessPartnerRole {  };
  to_BusinessPartnerTax : Association to many DELL.A_BusinessPartnerTaxNumber {  };
  to_BusPartAddrDepdntTaxNmbr : Association to many DELL.A_BusPartAddrDepdntTaxNmbr {  };
  to_Customer : Association to DELL.A_Customer {  };
  to_PaymentCard : Association to many DELL.A_BusinessPartnerPaymentCard {  };
  to_Supplier : Association to DELL.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity DELL.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  to_AddressUsage : Association to many DELL.A_BuPaAddressUsage {  };
  to_BPAddrDepdntIntlLocNumber : Association to DELL.A_BPAddrDepdntIntlLocNumber {  };
  to_BPIntlAddressVersion : Association to many DELL.A_BPIntlAddressVersion {  };
  to_EmailAddress : Association to many DELL.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many DELL.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many DELL.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many DELL.A_AddressPhoneNumber {  };
...
entity DELL.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity DELL.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity DELL.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  @sap.quickinfo : 'Business Partner Relationship Category'
  RelationshipCategory : String(6);
  to_ContactAddress : Association to many DELL.A_BPContactToAddress {  };
  to_ContactRelationship : Association to DELL.A_BPContactToFuncAndDept {  };
};
...
entity DELL.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity DELL.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Role'
entity DELL.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity DELL.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity DELL.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_Customer {
  ...
  to_CustAddrDepdntExtIdentifier : Association to many DELL.A_CustAddrDepdntExtIdentifier {  };
  to_CustAddrDepdntInformation : Association to many DELL.A_CustAddrDepdntInformation {  };
  to_CustomerCompany : Association to many DELL.A_CustomerCompany {  };
  to_CustomerSalesArea : Association to many DELL.A_CustomerSalesArea {  };
  to_CustomerTaxGrouping : Association to many DELL.A_CustomerTaxGrouping {  };
  to_CustomerText : Association to many DELL.A_CustomerText {  };
  to_CustomerUnloadingPoint : Association to many DELL.A_CustomerUnloadingPoint {  };
  to_CustUnldgPtAddrDepdntInfo : Association to many DELL.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity DELL.A_CustomerCompany {
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_CompanyText : Association to many DELL.A_CustomerCompanyText {  };
  to_CustomerDunning : Association to many DELL.A_CustomerDunning {  };
  to_WithHoldingTax : Association to many DELL.A_CustomerWithHoldingTax {  };
};
...
entity DELL.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_PartnerFunction : Association to many DELL.A_CustSalesPartnerFunc {  };
  to_SalesAreaTax : Association to many DELL.A_CustomerSalesAreaTax {  };
  to_SalesAreaText : Association to many DELL.A_CustomerSalesAreaText {  };
  to_SlsAreaAddrDepdntInfo : Association to many DELL.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity DELL.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  to_SlsAreaAddrDepdntTax : Association to many DELL.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity DELL.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity DELL.A_Supplier {
  ...
  to_SupplierCompany : Association to many DELL.A_SupplierCompany {  };
  to_SupplierPurchasingOrg : Association to many DELL.A_SupplierPurchasingOrg {  };
  to_SupplierText : Association to many DELL.A_SupplierText {  };
};
...
entity DELL.A_SupplierCompany {
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_CompanyText : Association to many DELL.A_SupplierCompanyText {  };
  to_Supplier : Association to DELL.A_Supplier {  };
  to_SupplierDunning : Association to many DELL.A_SupplierDunning {  };
  to_SupplierWithHoldingTax : Association to many DELL.A_SupplierWithHoldingTax {  };
};
...
entity DELL.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity DELL.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity DELL.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_PartnerFunction : Association to many DELL.A_SupplierPartnerFunc {  };
  to_PurchasingOrgText : Association to many DELL.A_SupplierPurchasingOrgText {  };
};
...
entity DELL.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity DELL.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
